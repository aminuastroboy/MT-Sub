      ...
      <section className="hero-card card">
        <div className="brand-row">
          ...
          <div>
            ...
            <div style={{ opacity: .86, fontSize: '.9rem' }}>By Musatech Solutions Ltd</div>
          </div>
        </div>
        <h1 style={{ margin: '1rem 0 .6rem', fontSize: '2rem', lineHeight: 1.1 }}>Buy data and airtime fast.</h1>
        <p style={{ margin: 0, lineHeight: 1.65, opacity: .94 }}>
          A simple mobile-first app for quick VTU purchases in Nigeria. Just fund your wallet, choose a network and buy in seconds.
        </p>
      </section>
